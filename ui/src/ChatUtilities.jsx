...
function MenuIcon({setAddFriendDisplay}) {
  ...
  function ChatUtilities({ setAddFriendDisplay }) {
    ...
    return (
      <div
        id="chat-utilities"
        className="w-full basis-1/6 flex flex-col justify-evenly items-center"
      >
        <div className="w-full flex flex-row justify-between items-center">
          <h6 className="basis-4/6">{user.username}</h6>
          <MenuIcon setAddFriendDisplay={setAddFriendDisplay}/>
        </div>
