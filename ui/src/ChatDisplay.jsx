...
function ChatDisplay({setChatMessages,chatMessages,addFriendDisplay,setAddFriendDisplay,friendsList,setFriendsList,currentChat})
{

    if(addFriendDisplay)
    {
        return (
            <FriendScreen setAddFriendDisplay={setAddFriendDisplay} friendsList={friendsList} setFriendsList={setFriendsList} />
        );
    }
    else
    {
